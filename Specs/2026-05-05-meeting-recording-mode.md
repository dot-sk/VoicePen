...
- Automated: `VoicePenTests/App/AppControllerTests.swift` covers consent gating, permission gating, meeting state, meeting processing state, meeting chunk progress, meeting timeout recovery, and no conflict with dictation history.
